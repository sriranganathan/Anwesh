...
<html>
    <head>
        <title>Ingenium Phase Two</title>
...
<br>
        ...
        <div id="content" class="container-fluid">
            <div class="well" id="form_container">
                ...
                @endif
                <form method="post" action="{{action('HomeController@phaseTwo',['t'=>$uniq_id])}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-lg-4" style="margin: auto; float: none;">
                            <div class="panel panel-primary">
                                <div class="panel-heading">Ingenium Phase 2</div>
                                <div class="panel-body">
                                    ...
                                    <br/>
                                     <div class="input-group">
                                        ...
                                        <input type="text" id="college-1" name="college1" class="form-control" placeholder="college" aria-describedby="college-addon-1" title="college" value="{{$college}}" readonly>
                                    </div>
                                    <br/>
                                    <div class="input-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-sm-offset-4 vcenter">
