...
<html>
    ...
    <body>
        ...
        <div class="col-sm-12 col-md-10 col-md-offset-1">
            ...
            <div class="col-sm-12">
                <ul>
                    <li class="list_item">Scientific fraud and misconduct are not condoned at any level of research or during the course of the competition. This includes plagiarism, forgery, use or presentation of other researchers' work as one’s own and fabrication of data. Fraudulent projects will fail to qualify for competition.</li>
                    <li><h3 class="text-warning">First Round:</h3></li>
                        <ol>
                    ...
                    <li><h3 class="text-warning">Second Round:</h3></li>
                        <ol>
                    ...
                    <li><h3 class="text-warning">Final Round:</h3></li>
                        <ol>
